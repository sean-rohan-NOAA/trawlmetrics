...
png(file = here::here("plots", "trawl_height_width.png"), width = 7, height = 10, res = 600, units = "in")
print(
cowplot::plot_grid(
ggplot() +
...
[![Distribution of net height and spread for all nets used during the survey (numbered nets) and for all nets with measurement data since 2005. Circles show the average, box shows 25-75% range, thin line shows full range. Labels along the vertical axis show the number of hauls for each net. Colors show whether the average for a net fell within the 25-75% range for the full 2005-present data set. ](./plots/trawl_height_width.png)](%60r%20paste0(%22Trawl%20height%20and%20width%20from%20the%20%22,%20year,%20%22%20%22,%20paste(survey,%20sep%20=%20%22%20and%20%22),%20%22survey(s).%22)%20%60)

| Field      | Value                          | Field        | Value                                                       |
|--------------------|------------------|------------------|------------------|
| Net number | `r sel_net_summary$NET_NUMBER` | Good hauls   | `r sel_net_summary$N_GOOD`                                  |
| Gear       | `r sel_net_summary$GEAR`       | Bad hauls    | `r sel_net_summary$N_BAD`                                   |
| Year       | `r sel_net_summary$YEAR`       | Avg. Height  | `r paste0(round(sel_net_summary$MEAN_NET_HEIGHT, 1), " m")` |
| Survey     | `r paste(survey, sep =",")`    | Avg. Spread  | `r paste0(round(sel_net_summary$MEAN_NET_WIDTH, 1), " m")`  |
| vessel     | `r sel_net_summary$VESSEL`     | Out-of-range | NA                                                          |
...
flextable::flextable(cwidth = c(1.25, 0.75, 0.75, 0.75, 3.5)) |>
